                ...
                <div class="card-body">
                    <form action="addProducto.jsp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="txtPrecioProducto" name="txtPrecioProducto" step=0.01 min=0>
                        </div>
                        <div class="mb-3">
                            <label for="txtStockProducto" class="form-label">Stock</label>
                            <input type="number" class="form-control" id="txtStockProducto" name="txtStockProducto" min=0>
                        </div>

                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-outline-dark">Agregar nuevo producto</button>
